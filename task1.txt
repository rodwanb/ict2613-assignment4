<?php
     ...
     * Purpose: Assignment 4 - Task 1
     * 
     * ************************************************************** */

    // array of schools used in form selection
    const SCHOOLS = [
    ...
    // grades from 1-9 to be used in form selection
    $grades = range(1, 9);

    // get selected action from form submission
    $action = filter_input(INPUT_POST, 'action');

    // process form data if submit action is 'register'
    if ($action == 'register') {
